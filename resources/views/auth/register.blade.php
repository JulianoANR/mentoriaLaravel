            ...
            <form action="{{ route('auth.register.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text"
                                class="form-control {{ $errors->has('user.cpf') ? 'is-invalid' : '' }}" name="user[cpf]"
...
aa
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" name="phones[0][number]" class="form-control {{ $errors->has('phones.0.number') ? 'is-invalid' : '' }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" name="phones[1][number]" class="form-control {{ $errors->has('phones.1.number') ? 'is-invalid' : '' }}"
