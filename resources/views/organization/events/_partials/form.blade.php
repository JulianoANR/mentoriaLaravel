    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}"
                id="start_date" name="start_date" value="{{ old('start_date', isset($event) ? $event->start_date_formatted : '') }}" 
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}"
                id="end_date" name="end_date" value="{{ old('end_date', isset($event) ? $event->end_date_formatted : '') }}"
                data-mask="00/00/0000 00:00"
                    >
                    <div class="invalid-feedback">{{ $errors->first('end_date') }}
        </div>
    </div>
</div>
<div class="col-lg-3">
    <div class="form-group">
        ...
        <input type="number" class="form-control {{ $errors->has('participants_limit') ? 'is-invalid' : '' }}"
            id="participants_limit" name="participants_limit" min="1" value="{{ old('participants_limit', isset($event) ? $event->participants_limit : '') }}">
