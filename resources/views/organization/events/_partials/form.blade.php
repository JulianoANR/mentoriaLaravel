...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('speaker_name') ? 'is-invalid' : '' }}"
                id="speaker_name" name="speaker_name" value="{{ old('speaker_name', isset($event) ? $event->speaker_name : '' ) }}">
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}"
                id="start_date" name="start_date" value="{{ old('start_date', isset($event) ? $event->start_date_formatted : '' ) }}" data-mask="00/00/0000 00:00">
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}"
                id="end_date" name="end_date" value="{{ old('end_date', isset($event) ? $event->end_date_formatted : '' ) }}" data-mask="00/00/0000 00:00">
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <input type="number" class="form-control {{ $errors->has('participant_limit') ? 'is-invalid' : '' }}"
                id="participant_limit" name="participant_limit" min="1" value="{{ old('participant_limit', isset($event) ? $event->participant_limit : '') }}">
            <div class="invalid-feedback">{{ $errors->first('participant_limit') }}</div>
        </div>
    </div>
    <div class="col-12">
        <div class="form-group">
